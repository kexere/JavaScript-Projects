...
function Input_Decimal(dot) {
    //This ensures taht accidental clicking of the decimal point doesn't
    //cause bugs in the operation.
    if (Calculator.Wait_Second_Operand === 'true') return;
    if (!Calculator.Display_Value.includes(dot)) {
        //We are sayling that if the Display_Value does not contain a decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the screen to a number and then store the result on
...
//Resets the claculator when the AC button is clicked
